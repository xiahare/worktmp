DROP MATERIALIZED VIEW IF EXISTS __root_siem_siem_day_mv_sync_agg_states_all;
CREATE MATERIALIZED VIEW IF NOT EXISTS __root_siem_siem_day_mv_sync_agg_states_all AS
SELECT
    adomid,
    time_slice(`itime`, INTERVAL 1 day, floor) AS itime_day,
    src_ip,
    dst_ip,
    data_sourceid,
    epid,
...
GROUP BY
    adomid,
    time_slice(`itime`, INTERVAL 1 day, floor),
    src_ip,
    dst_ip,
    data_sourceid,
    epid,
