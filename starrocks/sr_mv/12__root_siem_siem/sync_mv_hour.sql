DROP MATERIALIZED VIEW IF EXISTS __root_siem_siem_hour_mv_sync_agg_states_all;
CREATE MATERIALIZED VIEW IF NOT EXISTS __root_siem_siem_hour_mv_sync_agg_states_all AS
SELECT
    adomid,
