DROP MATERIALIZED VIEW IF EXISTS __root_siem_siem_5min_mv_sync_agg_states_all;
CREATE MATERIALIZED VIEW IF NOT EXISTS __root_siem_siem_5min_mv_sync_agg_states_all AS
SELECT
    adomid,
    time_slice(`itime`, INTERVAL 5 minute, floor) AS itime_5min,
    src_ip,
    dst_ip,
    data_sourceid,
    epid,
