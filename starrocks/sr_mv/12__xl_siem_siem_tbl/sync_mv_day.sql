DROP MATERIALIZED VIEW IF EXISTS __xl_siem_siem_day_mv_sync_agg_states_all;
CREATE MATERIALIZED VIEW IF NOT EXISTS __xl_siem_siem_day_mv_sync_agg_states_all AS
SELECT
    adomid,
